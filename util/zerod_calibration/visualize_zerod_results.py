...
Examples:
  ...
  python3 visualize_zerod_results.py --set-name set_3 --geo-name tree_006
...
# python3 util/zerod_calibration/visualize_zerod_results.py --set-name set_3 --geo-name tree_007
