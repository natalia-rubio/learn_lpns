...
def main():
    ...
    # Step 3.6: After calibration, run NN inference for BloodVesselJunction on bifurcations geometry
        ...
        if args.NN_only:
            ...
            if 'BloodVesselJunction' in args.junction_types:
                ...
                if os.path.exists(nn_output_path):
                    ...
                    raise FileNotFoundError(f"NN output file not found: {nn_output_path}")
        else:
