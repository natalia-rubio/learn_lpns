...
``util.visualizations.cv_cross_set_summary_barchart.py`` (internal set_name -> short label).

Requires in the LaTeX preamble::
    \\usepackage{booktabs}

Usage::
  python -m util.visualization.write_vmr_cohort_geometries_latex
  python -m util.visualization.write_vmr_cohort_geometries_latex -o results/vmr_cohort_geometries.tex
"""
