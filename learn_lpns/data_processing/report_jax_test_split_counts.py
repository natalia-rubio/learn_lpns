...
**Environment:** pickles contain JAX arrays. Run with the **svVasc_clean** conda env::
    ...
    python -m learn_lpns.data_processing.report_jax_test_split_counts

Or::

    conda run -n svVasc_clean python -m learn_lpns.data_processing.report_jax_test_split_counts

Usage::
  python -m learn_lpns.data_processing.report_jax_test_split_counts
  python -m learn_lpns.data_processing.report_jax_test_split_counts VMR_abdo VMR_pulmo_healthy
  python -m learn_lpns.data_processing.report_jax_test_split_counts --data_root /path/to/data
"""
