...
Usage:
  python learn_lpns/visualizations/plot_feature_vs_lumped_params.py VMR_rigid_aorta_adults
  python learn_lpns/visualizations/plot_feature_vs_lumped_params.py VMR_rigid_aorta_adults --mode junction
  python learn_lpns/visualizations/plot_feature_vs_lumped_params.py VMR_rigid_aorta_adults \\
