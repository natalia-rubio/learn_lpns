#!/bin/bash 
#SBATCH --job-name=tree_013
#SBATCH --partition=amarsden
#SBATCH --output=/scratch/users/nrubio/job_scripts/tree_013.o%j
#SBATCH --error=/scratch/users/nrubio/job_scripts/tree_013.e%j
#SBATCH --time=3:00:00
#SBATCH --mem=50000
#SBATCH --nodes=2
...
export F1='/scratch/users/nrubio/synthetic_junctions/CCO_trees/set_1/tree_013'
